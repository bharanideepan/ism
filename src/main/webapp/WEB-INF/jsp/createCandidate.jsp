   ...
   <body>
      ...
      <form:form name ="form" action="saveCandidate" method="post" modelAttribute="candidate" enctype = "multipart/form-data">
         <table class="table">
            ...
            <tr>
               <td colspan = "3">Candidate Information </td>
            <tr>
               <td >Name:</td>
               <td>
            ...
            <tr>
               <td>Phone Number:</td>
               <td>
                  <form:input type ="tel"  maxlength="10" value="${candidate.phoneNumber}" path="phoneNumber" required="required"/>
               </td>
            </tr>
            <tr>
               <td>Email Id:</td>
            ...
            <tr>
               <td>Experience:</td>
               <td>
                  <form:input type ="text" value="${candidate.experience}" path="experience" required="required"/>
               </td>
            </tr>
            <tr>
               <td>Resume:</td>
