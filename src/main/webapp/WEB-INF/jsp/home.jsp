...
=======
   ...
   <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60" onload="currentStatus('${status}')">
      <nav class="navbar navbar-default navbar-fixed-top">
         <div class="container">
            <div class="navbar-header">
               <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
      ...
      <div id="services" class="container-fluid text-center">
         ...
         <div class="row">
         <div class="col-sm-6">
            <h2 align="left">Candidate &nbsp Status &nbsp Description</h2>
            <br>
            <h4 align="left" >New - When a candidate is newly added. <br><br>
               Pending - When a candidate is assigned for an interview.<br><br>
               Cleared - When a candidate clears the interview assinged.<br><br>
               Cancelled - When a Schedule assigned for a candidate is cancelled.<br><br>
               Selected - When a candidate is selected for the company.<br><br>
               Rejected - When a candidate is rejected in the interview.
            </h4>
            <p></p>
         </div>
         <div class="col-sm-6">
            <h2 align="left">Schedule &nbsp Status &nbsp Description</h2>
            <br>
            <h4 align="left">New - When a new schedule is assinged for a candidate. <br><br>
               Selected - When a candidate is selected for the company.<br><br>
               Rejected - When a candidate is rejected in the interview. <br><br>
      ...
      <div id="loginForm" class="loginform">
         <div id="comment" style="display:none;">Invalid Username or Password</div>
         <div class="bg">
            <form:form  id="loginUser" method="post" action="loginUser" modelAttribute="user">
               <div class="form-group">
                  <label for="email" >Username:</label><br>
               ...
               <br>
                  <div>
                     <button  style="float:left;" type="submit" onclick="login()" class="btn btn-primary" value="Login">Login</button>
                     <input  style="float:right; background-color: #B22222;" type="button" id="close" style="background-color: red;" class="btn btn-primary" value="Close"> 
                  </div>
            </form:form>
         </div>
      </div>
      <script>
      function currentStatus(result) {
       	    if (result === "badCredential") {
...
>>>>>>> 15210dd8fc1c1a47b577ec3feba5943a62d60eec
