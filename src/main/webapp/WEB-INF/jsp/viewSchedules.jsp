   ...
   <body>
      <div class="col-md-12 col-md-offset-0">
                ...
                <div class="container-fluid">
                  ...
                  <div class="navbar-form navbar-right" >
                     <div class="form-group">
                        <input id="enteredDate"value=""  type="date" class="form-control" name="shdate" title="Pick a date" required>
                     </div>
                     ...
                     <table class = "table" id="contentTable">
                        ...
                        <c:forEach var="schedule" items="${pagenationInfo.scheduleInfos}">
                           <tr>
                              ...
                              <td>
                                 <a href="getScheduleWithInterviewers?scheduleId=${schedule.id}">&#9776;</a>
                              </td>
                           </tr>
                        </c:forEach>
                     </table>
         ...
         <footer class="container-fluid text-center">
            <p>Visit our page <a href="https://www.ideas2it.com" title="Visit Ideas2It">Copyrights &copy; Ideas2It</a></p>
         </footer>	
